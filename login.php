		  	...
		  	if ($status=='admin')
		  		{
				 	...
				 	echo "<script type='text/javascript'>document.location='pages/exam.php'</script>";
				 }
			  else
			  {

					echo "<script type='text/javascript'>document.location='pages/faculty_exam1.php'</script>";
				}
