...
<html>
  ...
  <body class="hold-transition login-page" style="background:#57A019">
   
   
  <!-- <img src = "../dist/img/logofatimaa.png" width ="120px" height="120px" class="logo" style="position: absolute"> --> 
